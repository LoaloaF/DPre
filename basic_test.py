...
from DPre import Samples, Targets, TARGET, config
...
t.target_similarity_heatmap(c, 'euclid',  differential=True, proportional=False,
...
t.ranked_similarity_barplot(c, 'intersect',
                            differential=False,
                            proportional=True,
                            rank_samples=True,
                            show_negative=True,
