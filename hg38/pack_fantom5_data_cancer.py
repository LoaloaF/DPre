...
This version is the cancer cell and cell line containing one.
...
for entry, line in enumerate(oh):
    if "00Annotation" in line: # get the condition names
        ...
        cancer_names = set([
            "infection",
            "lipopolysaccharide", "SABiosciences",
...
gl.reverse()
gl.save("hg38.fantom5.cancer.glb")
gl.saveTSV("hg38.fantom5.cancer.tsv")
